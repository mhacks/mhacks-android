...
class CollapsibleCard @JvmOverloads constructor(
    ...
    init {
        val arr = context.obtainStyledAttributes(attrs, coreR.styleable.CollapsibleCard, 0, 0)
        cardTitle = arr.getString(coreR.styleable.CollapsibleCard_cardTitle)!!
        val cardDescription = arr.getString(coreR.styleable.CollapsibleCard_cardDescription)
        arr.recycle()
