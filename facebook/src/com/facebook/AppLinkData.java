...
public class AppLinkData {
    ...
    public static final String ARGUMENTS_TAPTIME_KEY      =
            "com.facebook.platform.APPLINK_TAP_TIME_UTC";
    /**
    ...
    public static void fetchDeferredAppLinkData(
        ...
        Settings.getExecutor().execute(new Runnable() {
            @Override
            public void run() {
                fetchDeferredAppLinkFromServer(applicationContext,
                                               applicationIdCopy,
                                               completionHandler);
            }
        });
    ...
    private static void fetchDeferredAppLinkFromServer(
        ...
        try {
            ...
            JSONObject jsonResponse =
                    wireResponse != null ? wireResponse.getInnerJSONObject() : null;
            ...
            if (method.equals("applink") && version.equals("2")) {
                ...
                if (appLinkData.arguments.has(METHOD_ARGS_REF_KEY)) {
                    ...
                    JSONObject refererData =
                            appLinkData.arguments.getJSONObject(ARGUMENTS_REFERER_DATA_KEY);
