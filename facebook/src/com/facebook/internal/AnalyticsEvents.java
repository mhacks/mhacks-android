...
public class AnalyticsEvents {
    ...
    public static final String EVENT_WEB_LOGIN_COMPLETE           =
    ...
    public static final String PARAMETER_WEB_LOGIN_SWITCHBACK_TIME         =
    ...
    public static final String EVENT_NATIVE_DIALOG_TYPE_MESSAGE       =
            "fb_dialogs_present_message";
    public static final String EVENT_NATIVE_DIALOG_TYPE_OG_SHARE      =
