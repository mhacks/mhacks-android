...
public final class NativeProtocol {
    ...
    public static final String EXTRA_DESCRIPTION         =
            "com.facebook.platform.extra.DESCRIPTION";
    ...
    public static final String EXTRA_ACTION_TYPE           =
            "com.facebook.platform.extra.ACTION_TYPE";
    ...
    public static final String STATUS_ERROR_SUBCODE     =
            "com.facebook.platform.status.ERROR_SUBCODE";
    ...
    public static Intent createProxyAuthIntent(Context context,
        ...
        for (NativeAppInfo appInfo : facebookAppInfoList) {
            ...
            intent.putExtra(ServerProtocol.DIALOG_PARAM_DEFAULT_AUDIENCE,
    ...
    public static int getLatestAvailableProtocolVersionForService(Context context,
    ...
    public static int getLatestAvailableProtocolVersionForAction(Context context,
                                                                 String action,
                                                                 final int minimumVersion) {
    ...
    private static int getLatestAvailableProtocolVersionForAppInfoList(Context context,
        ...
        for (NativeAppInfo appInfo : appInfoList) {
            int protocolVersion =
                    getLatestAvailableProtocolVersionForAppInfo(context, appInfo, minimumVersion);
    ...
    private static int getLatestAvailableProtocolVersionForAppInfo(Context context,
