...
class AuthorizationClient implements Serializable {
    ...
    // maintainability.
    private static final String EVENT_NAME_LOGIN_METHOD_START            =
            "fb_mobile_login_method_start";
    private static final String EVENT_NAME_LOGIN_METHOD_COMPLETE         =
            "fb_mobile_login_method_complete";
    private static final String EVENT_PARAM_METHOD_RESULT_SKIPPED        = "skipped";
    static final         String EVENT_NAME_LOGIN_START                   = "fb_mobile_login_start";
    static final         String EVENT_NAME_LOGIN_COMPLETE                =
    ...
    boolean checkInternetPermission() {
        ...
        if (permissionCheck != PackageManager.PERMISSION_GRANTED) {
            String errorType =
                    context.getString(R.string.com_facebook_internet_permission_error_title);
            String errorDescription =
                    context.getString(R.string.com_facebook_internet_permission_error_message);
    ...
    RequestBatch createReauthValidationBatch(final Result pendingResult) {
        ...
        Request requestCurrentTokenPermissions =
                createGetPermissionsRequest(validateSameFbidAsToken);
        requestCurrentTokenPermissions.setCallback(new Request.Callback() {
            @Override
            public void onCompleted(Response response) {
                try {
                    Session.PermissionsPair permissionsPair =
                            Session.handlePermissionResponse(response);
            ...
            public void onBatchCompleted(RequestBatch batch) {
                try {
                    ...
                    if (fbids.size() == 2 && fbids.get(0) != null && fbids.get(1) != null &&
                        ...
                        result = Result
                                .createErrorResult(pendingRequest,
    ...
    private AppEventsLogger getAppEventsLogger() {
        if (appEventsLogger == null ||
            !appEventsLogger.getApplicationId().equals(pendingRequest.getApplicationId())) {
    ...
    private void logAuthorizationMethodComplete(String method,
                                                Result result,
                                                Map<String, String> loggingExtras) {
    ...
    class WebViewAuthHandler extends AuthHandler {
        ...
        boolean tryAuthorize(final AuthorizationRequest request) {
            ...
            WebDialog.Builder builder =
                    new AuthDialogBuilder(getStartActivityDelegate().getActivityContext(),
                                          applicationId,
                                          parameters)
                            .setE2E(e2e)
        ...
        void onWebDialogComplete(AuthorizationRequest request, Bundle values,
            ...
            if (values != null) {
                ...
                AccessToken token = AccessToken
                        .createFromWebBundle(request.getPermissions(),
                                             values,
                ...
                if (error instanceof FacebookOperationCanceledException) {
                    ...
                    outcome =
                            Result.createErrorResult(pendingRequest, null, errorMessage, errorCode);
                }
            }
    ...
    class KatanaProxyAuthHandler extends KatanaAuthHandler {
        ...
        boolean tryAuthorize(AuthorizationRequest request) {
            ...
            String e2e = getE2E();
            Intent intent =
                    NativeProtocol.createProxyAuthIntent(context,
        ...
        private Result handleResultOk(Intent data) {
            ...
            if (error == null && errorCode == null && errorMessage == null) {
                AccessToken token =
                        AccessToken.createFromWebBundle(pendingRequest.getPermissions(), extras,
    ...
    static class Result implements Serializable {
        ...
        private Result(AuthorizationRequest request,
                       Code code,
                       AccessToken token,
                       String errorMessage,
                       String errorCode) {
        ...
        static Result createErrorResult(AuthorizationRequest request,
                                        ...
                                        String errorCode) {
            String message =
                    TextUtils.join(": ", Utility.asListNoNulls(errorType, errorDescription));
