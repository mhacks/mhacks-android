...
public class WeekViewModified extends View {
    ...
    private final GestureDetector.SimpleOnGestureListener mGestureListener = new GestureDetector.SimpleOnGestureListener() {
        ...
        public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
            if (mCurrentScrollDirection == Direction.NONE) {
                if (Math.abs(distanceX) > Math.abs(distanceY) && horizontalScrollEnabled){
        ...
        public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
            ...
            if (mCurrentFlingDirection == Direction.HORIZONTAL && horizontalScrollEnabled){
                mScroller.fling((int) mCurrentOrigin.x, 0, (int) (velocityX / 1.85), 0, Integer.MIN_VALUE, Integer.MAX_VALUE, 0, 0);
            }
            else if (mCurrentFlingDirection == Direction.VERTICAL && verticalScrollEnabled){
                mScroller.fling(0, (int) mCurrentOrigin.y, 0, (int) (velocityY / 1.85), 0, 0, (int) -(mHourHeight * 24 + mHeaderTextHeight + mHeaderRowPadding * 2 - getHeight()), 0);
            }

            ViewCompat.postInvalidateOnAnimation(WeekViewModified.this);
            return true;
        }
    ...
    public WeekViewModified(Context context) {
        this(context, null);
    }

    public WeekViewModified(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public WeekViewModified(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas); // Casues fatal exception "MonthChangedListener was not provided"
    ...
    public WeekView.EventClickListener getEventClickListener() {
        return (WeekView.EventClickListener) mEventClickListener;
    }

    public WeekView.MonthChangeListener getMonthChangeListener() {
        return (WeekView.MonthChangeListener) mMonthChangeListener;
    }
    ...
    public WeekView.EventLongPressListener getEventLongPressListener() {
        return (WeekView.EventLongPressListener) mEventLongPressListener;
    }
...
public int getHeaderRowPadding() {
    ...
    /**
     * Returns whether or not horizontal scroll is enabled.
     * @return true if horizontal scroll is enabled, false if not.
     */
    ...
    /**
     * Sets whether or not horizontal scrolling is enabled.
     * @param scrollEnabled scrollEnabled
     */
    public void setHorizontalScrollEnabled(boolean scrollEnabled) {
        horizontalScrollEnabled = scrollEnabled;
    }

    /**
     * Returns whether or not vertical scroll is enabled.
     * @return true if vertical scroll is enabled, false if not.
     */
    ...
    /**
     * Sets whether or not vertical scrolling is enabled.
     * @param scrollEnabled scrollEnabled
     */
    public void setVerticalScrollEnabled(boolean scrollEnabled) {
        verticalScrollEnabled = scrollEnabled;
    }

    /**
     * Sets today's date.
     * @param calendar of the day the view treats as "today".
     */
